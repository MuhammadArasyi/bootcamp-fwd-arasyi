            ...
            <form method="POST" action="{{ route('register') }}" class="grid gap-6">
              ...
              <label class="block">
                <input
                  ...
                  placeholder="Complete Name" name="name" id="name" for="name" value="{{ old('name') }}" required autofocus
                />
                @if($errors->has('name'))
              ...
              {{-- <label class="block">
                <input
                  type="text"
                  class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
                  placeholder="Age" name="age" id="age" for="age" required autofocus
                />
              </label> --}}
              ...
              <label class="block">
                <input
                  type="email"
                  class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
                  placeholder="Email Address" name="email" id="email" for="email" value="{{ old('email') }}" required autofocus
                />
                @if($errors->has('email'))
              ...
              <label class="block">
                <input
                  type="password"
                  class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
                  placeholder="Password" name="password" id="password" for="password" value="{{ old('password') }}" required autofocus
                />
              ...
              <label class="block">
                <input
                  type="password"
                  class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
                  placeholder="Password Confirmation" name="password_confirmation" id="password_confirmation" for="password_confirmation" required autofocus
                />
                @if($errors->has('password'))
                        <p class="text-red-500 mb-3 text-sm">{{ $errors->first('password') }}</p>
                    @endif
