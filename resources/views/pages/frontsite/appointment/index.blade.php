    ...
    <div class="min-h-screen">
        ...
        <div class="lg:w-1/3 mt-10 lg:mt-0">
            ...
            <form action="" class="mt-8 space-y-5">
              <label class="block">
                <select name="topic"  id="topic" class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"  placeholder="Topik Konsultasi" >
              ...
              <label class="block">
                <select  name="level" id="level" class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"  placeholder="Level" >
